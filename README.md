...
- __SocialController__: Este controlador tem como funcionalidade de implementar novos utilizadores juntamente com os APIs da Google, Facebook e Twitter. Neste controlador exige a instalação do [Laravel Socialite]{https://laravel.com/docs/6.x/socialite#installation} através do _Composer_ 
- __UserController__:
